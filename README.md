...
- **Party breakdown** — stacked 100% bar charts for all parties with ≥ 30 candidates, candidates and elected side-by-side
...
~77% of candidates in the source data had no recorded gender. Genders were predicted using a three-tier cascade:
...
| **Unknown** | ~16% | Primarily non-Western names not covered by the above sources |
